...
import com.jeremyseq.clashlings.common.*;
import com.jeremyseq.clashlings.common.level.Level;
import com.jeremyseq.clashlings.common.packets.C2S.MovementC2SPacket;
import com.jeremyseq.clashlings.common.packets.C2S.PositionC2SPacket;
...
public class Game extends JPanel implements ActionListener, Camera {
    ...
    public static final Logger LOGGER = new Logger("Client");
